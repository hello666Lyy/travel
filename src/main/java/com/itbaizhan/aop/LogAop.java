package com.itbaizhan.aop;

import com.itbaizhan.bean.Log;
...
public class LogAop {
    ...
    private final static Logger logger = (Logger) LoggerFactory.getLogger(LogAop.class);


    @Pointcut("execution(* com.itbaizhan.controller.backstage.*.*(..))")
